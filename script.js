...
*/
var	profile = "http://steamcommunity.com/profiles/76561198184542783",
	fl = true,
	url = "C:\\Users\\Alexander\\Documents\\My Workspace\\Script-for-SAM\\";
/*************************************************************************/
		...
		try {
			if (mainlist2[i].innerHTML.length > 19) {
				...
				if (temp2 == 0 || temp2 == "") {
					...
					str = "start " + url + "SAM.Game.exe " + sublist[0].href.substring(11+profile.length)
